<template>
    <div>
        <div class="login">
            <p class="text_center" style="font-size: .8rem;padding: 2rem 0;color: rgb(40, 130, 228);">登录</p>
            ...
            <div class="forget_password"><span @click="$router.push('/forgetpassword')">忘记密码？</span></div>
    ...
    export default {
        ...
        methods: {
            goLogin() {
                let _this = this;
                let api = "/v1/login";
                let password = md5(_this.password);
                this.$ajax.post(api,{
                    phone: this.phone,
                    password: password
